<div class="about-author">
    ...
    <div class="avatar-container">
        <div style="float:left; margin-right:20px;"><?php echo get_avatar($author_id )?></div>
        <h3 class="author-name">
            <span><?php _e('Posted by', 'fireball');?></span>
            ...
            <a href="<?php echo esc_url($author_posts_url)?>">
                <?php printf(esc_html(_n('This author has %s post', 'This author has %s posts', $author_posts, 'fireball')),number_format_i18n($author_posts)); ?></a>
        </h3>
